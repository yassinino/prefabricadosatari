            ...
            <div class="wt-contact-wrap row ">
                ...
                <div class="contact-right-part">
                    ...
                    <div class="p-a30  wt-box">
                        <h4 class="text-uppercase">DETALLES DEL CONTACTO </h4>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input name="email" type="text" class="form-control" required placeholder="Correo">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <textarea name="message" rows="4" class="form-control " required placeholder="Mensaje" ></textarea>
                                        </div>
                                    </div>
                                </div>
